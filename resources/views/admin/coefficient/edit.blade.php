                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-description">
                            Ici le formulaire pour modifier le <code> Coefficient </code> d'une <code>Matière</code> selon
                            la
                            <code>Classe</code>
                        </p>
                        <form class="forms-sample" action="{{ route('admin.coefficients.update', $coefficient->id) }}"
                            method="POST">
                            @method('put')
                            @csrf
